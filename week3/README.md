...
- [x]* **能说出原生版和 Vue 版的三条本质差别**（← 方案 C 的目的，不是「哪个好看」）
...
>
> **09-18 裁决：Week 4 暂不解锁。** 卡在 ② 和 ⑤ 两条 ——
> ② 补一句「你把结果塞回 messages」即可；⑤ 要 ly 自己在本机跑满四条路径并写下具体值。
> ④⑥ 是教练代填的 `[x]*`，Week 4 间隔回顾会重问。
